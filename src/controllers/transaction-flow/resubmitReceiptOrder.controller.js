...
exports.resubmitReceiptOrder = async (req, res) => {
  ...
  try {
    ...
    switch (approval.returned_from_level) {
      ...
      default:
        throw new Error("Invalid returned_from_level value");
    }
    ...
    await transactionApprovalModel.createNotification(connection, {
      ...
      title: "Receipt Request Resubmitted",
      message: "Returned Receipt request has been resubmitted for approval.",
    ...
    await transactionApprovalModel.updateStatusNotification(
      connection,
      approvalId,
      `Receipt request resubmitted and pending at ${approverName}.`,
    );
