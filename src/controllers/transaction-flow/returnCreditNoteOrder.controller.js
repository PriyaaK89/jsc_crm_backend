...
exports.returnCreditNoteOrder = async (req, res) => {
  ...
  try {
    ...
    switch (approval.approval_level) {
      ...
      case "SENIOR":
        ...
        // 4-level flow: Dispatcher must fix. 3-level flow (no dispatcher): Junior must fix.
    ...
    const returnMessage = `Credit Note returned by ${returnedByName}, order generated by ${employeeName}. Reason: ${reason}`;
